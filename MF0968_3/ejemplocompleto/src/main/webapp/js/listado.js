...
$(function() {
	$('#refrescarlistado').click(pedirPonentes);
	
	//setInterval(pedirPonentes, 5000);
});

function pedirPonentes() {
	$.getJSON('http://localhost:8080/api/ponentes', ponentesAHTML);
}

function ponentesAHTML(respuesta) {
